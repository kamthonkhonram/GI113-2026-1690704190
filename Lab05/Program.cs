...
// Step 1: Read Hero and Monster stats
...
bool allStatsValid = heroHpOk && heroAttackOk && heroDefenseOk
    && monsterHpOk && monsterAttackOk && monsterDefenseOk;
...
// Step 2: Potion and Damage Preview
int potionHeal = 8;
heroHp += potionHeal;
...
int criticalDamage = normalDamage
...
bool safeTrade = normalDamage > counterDamage
